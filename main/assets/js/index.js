...
(() => {
  ...
  var le = (e, t, r) => (
    ...
    tt = (e) => Ls(an({}, "__esModule", { value: !0 }), e);
  var Li = c(() => {
    "use strict";
    window.tram = (function (e) {
      ...
      function i(f, y, O) {
        return (
          "#" + ((1 << 24) | (f << 16) | (y << 8) | O).toString(16).slice(1)
        );
      }
      function o() {}
      function a(f, y) {
      ...
      function u(f, y, O) {
        if ((y !== void 0 && (O = y), f === void 0)) return O;
        var S = O;
        return (
          St.test(f) || !lt.test(f)
            ? (S = parseInt(f, 10))
            : lt.test(f) && (S = 1e3 * parseFloat(f)),
          0 > S && (S = 0),
          S === S ? S : O
        );
      }
      ...
      var p = (function (f, y, O) {
          ...
          function ee(ie, pe) {
            function j() {
              var Re = new ae();
              return I(Re.init) && Re.init.apply(Re, arguments), Re;
            }
            function ae() {}
            pe === O && ((pe = ie), (ie = Object)), (j.Bare = ae);
            var ue,
              be = (R[f] = ie[f]),
              et = (ae[f] = j[f] = new R());
            return (
        ...
        g = {
          ease: [
            ...
            function (f, y, O, S) {
              ...
              return (
                y +
                O * (-2.75 * R * I + 11 * I * I + -15.5 * R + 8 * I + 0.25 * f)
              );
            },
          ],
          "ease-in": [
          ...
          "ease-out": [
            ...
            function (f, y, O, S) {
              ...
              return (
                y +
                O * (0.3 * R * I + -1.6 * I * I + 2.2 * R + -1.8 * I + 1.9 * f)
              );
            },
          ],
          "ease-in-out": [
          ...
          "ease-in-out-expo": [
            ...
            function (f, y, O, S) {
              return f === 0
                ...
                ? y + O
                : (f /= S / 2) < 1
                ? (O / 2) * Math.pow(2, 10 * (f - 1)) + y
                : (O / 2) * (-Math.pow(2, -10 * --f) + 2) + y;
            },
          ],
          "ease-in-circ": [
          ...
          "ease-in-out-circ": [
            ...
            function (f, y, O, S) {
              return (f /= S / 2) < 1
                ? (-O / 2) * (Math.sqrt(1 - f * f) - 1) + y
                : (O / 2) * (Math.sqrt(1 - (f -= 2) * f) + 1) + y;
            },
          ],
          "ease-in-back": [
        ...
        D = function (f) {
          ...
          for (y = 0; y < v.length; y++)
            if (((O = v[y] + S), O in A.style))
              return { dom: O, css: L[y] + f };
        },
        U = (t.support = {
      ...
      if (U.transition) {
        var te = U.timing.dom;
        if (((A.style[te] = g["ease-in-back"][0]), !A.style[te]))
          for (var re in h) g[re][0] = h[re];
      }
      var F = (t.frame = (function () {
        ...
        Q = p(function (f) {
          function y(ne, ce) {
            ...
            ce = ce || {};
            var Ne = Y[fe];
            if (!Ne) return l("Unsupported property: " + fe);
          ...
          function ie(ne) {
            ee.call(this, ne), et.call(this, ne, yr, z_);
          }
          function pe(ne) {
          ...
          function K_(ne, ce) {
            ...
            for (me = 0; fe > me; me++) ne.apply(this.children[me], ce);
            return this;
          }
          (f.init = function (ne) {
            if (
            ...
            U.backface &&
              se.hideBackface &&
              E(this.el, U.backface.css, "hidden");
          }),
            He("add", y),
            He("start", O),
            He("wait", S),
        ...
        k = p(function (f) {
          function y() {
            ...
            this.update("auto");
            var ee = this.get();
            return this.update(R), ee;
          }
          function O(R, ee, ie) {
            return ee !== void 0 && (ie = ee), R in g ? R : ie;
          }
          function S(R) {
            var ee = /rgba?\((\d+),\s*(\d+),\s*(\d+)/.exec(R);
            return (ee ? i(ee[1], ee[2], ee[3]) : R).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
              ...
              se.fallback || pe.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    "ms" +
                    (this.ease != "ease" ? G + g[this.ease][0] : "") +
        ...
        W = p(k, function (f, y) {
          ...
          (f.init = function () {
            ...
            (f.transition = function (S) {
              ...
              var R,
                ee = {};
              for (R in this.current) ee[R] = R in I ? I[R] : this.current[R];
            ...
            (f.values = function (S) {
              var I,
                R = {};
              return (
                O.call(this, S, function (ee, ie, pe) {
                  (R[ee] = ie),
        ...
        q = p(function (f) {
          ...
          (f.init = function (j) {
            ...
            (f.play = function () {
              this.active ||
                (this.start || (this.start = X()), (this.active = !0), y(this));
            }),
            (f.stop = function () {
            ...
            (f.render = function (j) {
              ...
              if (ue < this.duration) {
                ...
                return (
                  (ae = this.startRGB
                    ? R(this.startRGB, this.endRGB, be)
          ...
          (f.init = function (O) {
            ...
            (f.render = function (O) {
              ...
              for (S = R; S--; )
                (I = this.tweens[S]),
                  I.context &&
                    (I.render(O), (this.current[I.name] = I.value), (ee = !0));
              return ee
      ...
      (t.fallback = function (f) {
        ...
        (t.delay = function (f, y, O) {
          return new oe({ complete: y, duration: f, context: O });
        }),
    ...
    Ps.exports = (function () {
      ...
      (e.map = e.collect =
        ...
        (e.find = e.detect =
          function (v, L, D) {
            var U;
            return (
              z(v, function (te, re, F) {
                if (L.call(D, te, re, F)) return (U = te), !0;
              }),
              U
            );
          }),
        ...
        e.any =
          function (v, L, D) {
            ...
            return v == null
              ...
              ? v.some(L, D)
              : (P(v, function (te, re, F) {
                  if (U || (U = L.call(D, te, re, F))) return t;
                }),
                !!U);
          });
      (e.contains = e.include =
        ...
        (e.debounce = function (v, L, D) {
          var U,
            ...
            Q = function () {
              ...
              V < L
                ? (U = setTimeout(Q, L - V))
                : ((U = null), D || ((X = v.apply(re, te)), (re = te = null)));
            };
          return function () {
            (re = this), (te = arguments), (F = e.now());
            var V = D && !U;
            return (
              U || (U = setTimeout(Q, L)),
              V && ((X = v.apply(re, te)), (re = te = null)),
              X
            );
          };
        }),
        ...
        (e.keys = function (v) {
          ...
          if (N) return N(v);
          var L = [];
          for (var D in v) e.has(v, D) && L.push(D);
          return L;
        }),
        (e.has = function (v, L) {
          return l.call(v, L);
...
` +
  ...
  var De = c((XV, Bs) => {
    ...
    de.ready = function () {
      (un = !0), Mi ? cb() : Xe.each(Bt, Ms), Xe.each(qi, Ms), de.resize.up();
    };
    function Ms(e) {
      rt(e) && e();
    }
    ...
    Hs.define(
      ...
      (Ws.exports = function (e) {
        ...
        function g() {
          ...
          h.length && h.remove(), b || i.append(l);
        }
        return t;
      })
    );
        ...
        function e(r) {
          ...
          function u(x) {
            var N = x.type,
              M = x.tagName;
            return !!(
              (M === "INPUT" && a[N] && !x.readOnly) ||
              (M === "TEXTAREA" && !x.readOnly) ||
              x.isContentEditable
            );
          }
          function l(x) {
  ...
  var tu = c(($V, eu) => {
    ...
    var ki = window.jQuery,
      ...
      ln = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), ki(t).triggerHandler(nt.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), ki(t).triggerHandler(nt.types.OUTRO));
        },
      };
    nt.triggers = {};
  ...
  var _r = c((QV, iu) => {
    ...
    fn.triggers = {};
    fn.types = { INTRO: "w-ix-intro" + nu, OUTRO: "w-ix-outro" + nu };
  ...
  var hn = c((AB, tc) => {
    ...
    tc.exports = function (e, t) {
      try {
        Jb(ec, e, { value: t, configurable: !0, writable: !0 });
      } catch {
        ec[e] = t;
      }
      return t;
  ...
  var mc = c((PB, Ec) => {
    ...
    Ec.exports = function (e, t) {
      ...
      if (r) {
        if (
          (t === void 0 && (t = "default"), (n = yT(r, e, t)), !vc(n) || hc(n))
        )
          return n;
  ...
  var Hc = c((XB, Bc) => {
    ...
    oI || go.state
      ? ((_t = go.state || (go.state = new lI())),
        (Gc = fo(_t.get)),
        (vo = fo(_t.has)),
        (Uc = fo(_t.set)),
        (_n = function (e, t) {
          if (vo(_t, e)) throw new ho(kc);
      ...
      : ((Lt = uI("state")),
        (cI[Lt] = !0),
        (_n = function (e, t) {
          if (po(e, Lt)) throw new ho(kc);
          return (t.facade = e), sI(e, Lt, t), t;
        }),
        (Sr = function (e) {
          return po(e, Lt) ? e[Lt] : {};
        }),
    ...
    var _t, Gc, vo, Uc, Lt;
    Bc.exports = { set: _n, get: Sr, has: bn, enforce: fI, getterFor: dI };
  });
  var jc = c((jB, Xc) => {
    var Eo = Rt(),
      pI = yt(),
    ...
    Xc.exports = { EXISTS: mo, PROPER: vI, CONFIGURABLE: hI };
  });
  var Qc = c((zB, $c) => {
    var EI = Ee(),
      zc = it(),
  ...
  var To = c((JB, ul) => {
    ...
    ul.exports = function (e, t) {
      var r = DI(e),
        ...
        i = [],
        o;
      for (o in r) !bo(GI, o) && bo(r, o) && sl(i, o);
      for (; t.length > n; ) bo(r, (o = t[n++])) && (~kI(i, o) || sl(i, o));
      return i;
    };
  });
  var Tn = c((eH, cl) => {
    ...
    _l.exports = function (e, t) {
      ...
      if (
        ...
        for (s in t) {
          if (
            ((l = t[s]),
            e.noTargetGet ? ((m = aO(a, s)), (u = m && m.value)) : (u = a[s]),
          ...
          (e.sham || (u && u.sham)) && sO(l, "sham", !0), uO(a, s, l, e);
        }
    };
  });
  var Il = c((sH, Tl) => {
  ...
  var Ml = c((lH, ql) => {
    ...
    ql.exports =
      ...
      function (t, r) {
        ...
        return (
          t !== null
            ? ((Oo[wo] = _O(t)), (n = new Oo()), (Oo[wo] = null), (n[Ll] = t))
            : (n = On()),
          r === void 0 ? n : bO(n, r)
        );
      };
  ...
  var Dl = c((fH, Fl) => {
    var xO = ro(),
      ...
      xo = xO("unscopables"),
      So = Array.prototype;
    So[xo] == null && CO.f(So, xo, { configurable: !0, value: SO(null) });
  ...
  var Fo = c((Nr) => {
    ...
    function hf(e, t, r) {
      ...
      return (
        g({ type: gf.INIT }),
        (n = { dispatch: g, subscribe: p, getState: m, replaceReducer: h }),
        (n[pf.default] = T),
        n
      );
    }
  ...
  var Yt = c((ye) => {
    ...
    function Cn(e, t) {
      if ((!Array.isArray(t) && Nf(Rf), e != null)) {
  ...
  var Jo = c((j5, Ip) => {
    ...
    function oC(e, t, r, n, i, o) {
      ...
      for (o.set(e, t), o.set(t, e); ++p < s; ) {
        var T = e[p],
          b = t[p];
        if (n) var w = a ? n(b, T, p, t, e, o) : n(T, b, p, e, t, o);
        if (w !== void 0) {
          if (w) continue;
          g = !1;
          break;
        ...
        if (h) {
          if (
            !tC(t, function (_, C) {
              if (!rC(h, C) && (T === _ || i(T, _, r, n, o))) return h.push(C);
            })
          ) {
            g = !1;
            break;
  ...
  var Ig = c((yW, Tg) => {
    ...
    function yN(e, t, r, n, i, o) {
      ...
      for (var p = u; p--; ) {
        var g = s[p];
        if (!(a ? g in t : mN.call(t, g))) return !1;
      }
      var h = o.get(e),
        T = o.get(t);
      ...
      for (var w = a; ++p < u; ) {
        ...
        var _ = e[g],
          C = t[g];
        if (n) var x = a ? n(C, _, g, t, e, o) : n(_, C, g, e, t, o);
  ...
  var Hn = c((OW, Dg) => {
    var sa = wg(),
      ...
      DN = rr(fa),
      qt = Fg;
    ((sa && qt(new sa(new ArrayBuffer(1))) != Mg) ||
      (ua && qt(new ua()) != Ng) ||
      (ca && qt(ca.resolve()) != Lg) ||
      (la && qt(new la()) != Pg) ||
      (fa && qt(new fa()) != qg)) &&
  ...
  var Xg = c((wW, Wg) => {
    ...
    function WN(e, t, r, n, i, o) {
      ...
      return g ? (o || (o = new da()), UN(e, t, r, n, i, o)) : !1;
    }
    Wg.exports = WN;
  });
  var pa = c((AW, Kg) => {
    ...
    function $N(e, t, r, n) {
      ...
      for (; ++i < o; ) {
        ...
        if (a && s[2]) {
          ...
          var p = new jN();
          if (n) var g = n(l, m, u, e, t, p);
          if (!(g === void 0 ? zN(m, l, KN | YN, n, p) : g)) return !1;
        }
      }
      return !0;
    }
  ...
  var mv = c((kW, Ev) => {
    ...
    function hv(e) {
      ...
      if (AL(e)) return wL(e, hv) + "";
      if (xL(e)) return vv ? vv.call(e) : "";
      var t = e + "";
  ...
  var Oa = c((uX, ch) => {
    ...
    ch.exports = function (t, r, n, i) {
      ...
      function s(u) {
        for (var l = 0, m = 1, p = Hr - 1; m !== p && o[m] <= u; ++m) l += Jn;
        --m;
  ...
  var Wr,
    ...
    wa = he(() => {
      ...
      (Wr = le(Oa())),
        (pt = 1.70158),
        (lq = (0, Wr.default)(0.25, 0.1, 0.25, 1)),
        (fq = (0, Wr.default)(0.42, 0, 1, 1)),
        (dq = (0, Wr.default)(0, 0, 0.58, 1)),
        (pq = (0, Wr.default)(0.42, 0, 0.58, 1));
    });
  var fh = {};
  Fe(fh, {
    applyEasing: () => Kq,
  ...
  function Kq(e, t, r) {
    return t === 0
      ...
      : t === 1
      ? 1
      : jr(r ? (t > 0 ? r(t) : t) : t > 0 && e && Xr[e] ? Xr[e](t) : t);
  }
  var lh,
    Aa = he(() => {
      "use strict";
  ...
  function ph(e, t, r, n, i) {
    let o =
      r === Yq ? (0, ir.getIn)(i, ["config", "target", "objectId"]) : null;
    return (0, ir.mergeIn)(e, [n], { id: n, ref: t, refId: o, refType: r });
  }
  function xa(e, t, r, n, i) {
    let o = lM(i);
    return (0, ir.mergeIn)(e, [t, sM, r], n, o);
  }
  function lM(e) {
    let { config: t } = e;
          ...
          switch (t.type) {
            ...
            case oM: {
              let {
                ...
                u = e;
              return (
                (0, ir.getIn)(u, [r, n]) !== n && (u = ph(u, n, a, r, o)),
                xa(u, r, s, i, o)
              );
            }
            case aM: {
  ...
  var Ca = c((Sa) => {
    ...
    function SM(e) {
      ...
      if (s.startsWith("#")) {
        ...
        i = parseFloat(u[3]);
        let g = (1 - Math.abs(2 * p - 1)) * m,
          h = g * (1 - Math.abs(((l / 60) % 2) - 1)),
          T = p - g / 2,
          b,
          w,
          _;
  ...
  var bh = c((ti) => {
    ...
    var Ra = (Ge(), tt(xf)),
      ...
      kM = Na(mh()),
      GM = Na(_h()),
      hX = (ti.pluginMethodMap = new Map([
        [Ra.ActionTypeConsts.PLUGIN_LOTTIE, { ...DM }],
        [Ra.ActionTypeConsts.PLUGIN_SPLINE, { ...kM }],
        [Ra.ActionTypeConsts.PLUGIN_VARIABLE, { ...GM }],
      ]));
  });
  var Th = {};
  Fe(Th, {
  ...
  var Uh = c((SX, Gh) => {
    ...
    function pF(e, t, r) {
      ...
      return (
        r !== void 0 &&
          ((i = lF(r)), (i = r < 0 ? fF(n + i, 0) : dF(i, n - 1))),
        uF(e, cF(t, 3), i, !0)
      );
    }
    Gh.exports = pF;
  ...
  function mF(e, t) {
    ...
    for (let i = 0; i < r.length; i++)
      if (!EF.call(t, r[i]) || !Hh(e[r[i]], t[r[i]])) return !1;
    return !0;
  }
  var EF,
    Va,
  ...
  function ja({
    ...
    let P = (t?.action?.config?.affectedElements ?? {})[b || _] || {},
      z = !!(P.id || P.selector),
      K,
      $,
      Z,
    ...
    if (
      (z
        ? ((K = P.limitAffectedElements), ($ = G), (Z = s(P)))
        : ($ = Z = s({ id: b, selector: _, selectorGuids: C })),
      t && N)
    ) {
      let A = r && (Z || N === !0) ? [r] : u(G);
      if (Z) {
        if (N === LF) return u(Z).filter((v) => A.some((L) => g(v, L)));
        if (N === Xh) return u(Z).filter((v) => A.some((L) => g(L, v)));
        if (N === jh) return u(Z).filter((v) => A.some((L) => h(L, v)));
      }
      return A;
    }
    return $ == null || Z == null
      ...
      case cr: {
        ...
        return (
          n.config.widthUnit === wt
            ? (l = Kh.test(s) ? parseFloat(s) : parseFloat(r.width))
            : (l = (0, gt.default)(parseFloat(s), parseFloat(r.width))),
          n.config.heightUnit === wt
            ? (m = Kh.test(u) ? parseFloat(u) : parseFloat(r.height))
            : (m = (0, gt.default)(parseFloat(u), parseFloat(r.height))),
  ...
  function $F({ element: e, actionItem: t, elementApi: r }) {
    ...
    switch (t.actionTypeId) {
      ...
      case cr: {
        ...
        if (a === wt) {
          let m = n(e, st);
          i(e, st, ""), (u = o(e, "offsetWidth")), i(e, st, m);
        }
        if (s === wt) {
          let m = n(e, ut);
          i(e, ut, ""), (l = o(e, "offsetHeight")), i(e, ut, m);
        }
  ...
  function nD(e, t, r, n, i) {
    let o = rD
        ...
        .join(" "),
      { setStyle: a } = i;
    Dt(e, Ot, i), a(e, Ot, o), aD(n, r) && a(e, Qn, xF);
  }
  function iD(e, t, r, n) {
    let i = (0, ai.default)(t, (a, s, u) => `${a} ${u}(${s}${tD(u, r)})`, ""),
      { setStyle: o } = n;
    Dt(e, zr, n), o(e, zr, i);
  }
  function oD(e, t, r, n) {
  ...
  function dD(e, t, r, n, i, o) {
    ...
    switch (n.actionTypeId) {
      case cr: {
        ...
        l !== void 0 && (s === wt && (s = "px"), Dt(e, st, o), a(e, st, l + s)),
          m !== void 0 &&
            (u === wt && (u = "px"), Dt(e, ut, o), a(e, ut, m + u));
        break;
      }
      case Qr: {
        iD(e, r, n.config, o);
  ...
  function gD({ store: e, elementApi: t }) {
    ...
    Object.keys(n).forEach((o) => {
      let a = n[o],
        ...
        { actionListId: u } = s,
        l = i[u];
      l && Yh({ actionList: l, event: a, elementApi: t });
    }),
      Object.keys(i).forEach((o) => {
        Yh({ actionList: i[o], elementApi: t });
      });
  }
  ...
  function $h({ actionGroup: e, event: t, elementApi: r }) {
    ...
    n.forEach((i) => {
      ...
      Mt(o)
        ? (s = (u) => Da(o)(u, i))
        : (s = aE({ effect: hD, actionTypeId: o, elementApi: r })),
  ...
  var gt,
    ...
    cE = he(() => {
      "use strict";
      (gt = le(Oh())), (ai = le(kh())), (ni = le(Bh())), (si = le(Yt()));
      Ge();
      Wh();
      Aa();
      Qh = le(Ca());
      ...
      ({
        ...
        (rE = (e) => e.trim()),
        (Xa = Object.freeze({ [lr]: Zh, [fr]: CF, [dr]: RF })),
        (nE = Object.freeze({
          [Ot]: _F,
          [Zh]: yF,
          [ii]: ii,
      ...
      (Kh = /px/),
        (WF = (e, t) =>
          t.reduce(
            (r, n) => (r[n.type] == null && (r[n.type] = JF[n.type]), r),
            e || {}
          )),
        (XF = (e, t) =>
          t.reduce(
    ...
    dE = he(() => {
      ...
      (li = le(kt())),
        ...
        (UD = (e, t) => {
          ...
          return (0, vt.merge)(e, { position: _, current: z });
        }),
        (VD = (e, t) => {
          let {
              active: r,
          ...
          switch (t.type) {
            ...
            case LD: {
              ...
              return (0, vt.set)(e, r, {
                ...
                skipToValue: K,
                customEasingFn:
                  Array.isArray(v) && v.length === 4 ? FD(v) : void 0,
              });
            }
            case PD: {
  ...
  var DE = c((QX, FE) => {
    ...
    function L1(e) {
      if (e == null) return 0;
      if (x1(e)) return S1(e) ? C1(e) : e.length;
      var t = A1(e);
  ...
  var Za = c((ej, BE) => {
    ...
    function D1(e, t, r) {
      t == "__proto__" && VE
        ? VE(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 })
        : (e[t] = r);
    }
    BE.exports = D1;
  });
  var WE = c((tj, HE) => {
    ...
    function B1(e, t, r) {
      var n = e[t];
      (!(V1.call(e, t) && G1(n, r)) || (r === void 0 && !(t in e))) &&
        k1(e, t, r);
    }
    HE.exports = B1;
  });
  ...
  var Om = c((Ej, Im) => {
    ...
    function ok(e, t, r) {
      ...
      function h(P) {
        var z = n,
          K = i;
        return (n = i = void 0), (l = P), (a = e.apply(K, z)), a;
      }
      function T(P) {
        return (l = P), (s = setTimeout(_, t)), m ? h(P) : a;
      }
      function b(P) {
        var z = P - u,
          K = P - l,
      ...
      function C(P) {
        return (s = void 0), g && n ? h(P) : ((n = i = void 0), a);
      }
      function x() {
  ...
  var Am = c((mj, wm) => {
    ...
    function ck(e, t, r) {
      ...
      return (
        ...
        ak(e, t, { leading: n, maxWait: t, trailing: i })
      );
    }
    wm.exports = ck;
  });
  ...
  var xm,
    ...
    gi = he(() => {
      ...
      (xm = le(kt())),
        ({
          IX2_RAW_DATA_IMPORTED: lk,
          IX2_SESSION_INITIALIZED: fk,
          IX2_SESSION_STARTED: dk,
          IX2_SESSION_STOPPED: pk,
          IX2_PREVIEW_REQUESTED: gk,
          IX2_PLAYBACK_REQUESTED: vk,
          IX2_STOP_REQUESTED: hk,
          IX2_CLEAR_REQUESTED: Ek,
          IX2_EVENT_LISTENER_ADDED: mk,
          IX2_TEST_FRAME_RENDERED: yk,
          IX2_EVENT_STATE_CHANGED: _k,
          IX2_ANIMATION_FRAME_CHANGED: bk,
          IX2_PARAMETER_CHANGED: Tk,
          IX2_INSTANCE_ADDED: Ik,
        ...
        (Pk = (e) => ({ type: hk, payload: { actionListId: e } })),
        (qk = () => ({ type: Ek })),
        (fi = (e, t) => ({
          type: mk,
          payload: { target: e, listenerParams: t },
        })),
        (Mk = (e = 1) => ({ type: yk, payload: { step: e } })),
        (is = (e, t) => ({ type: _k, payload: { stateKey: e, newState: t } })),
        (di = (e, t) => ({ type: bk, payload: { now: e, parameters: t } })),
        (gr = (e, t) => ({ type: Tk, payload: { key: e, value: t } })),
        (os = (e) => ({ type: Ik, payload: { ...e } })),
        (pi = (e, t) => ({ type: Ok, payload: { instanceId: e, time: t } })),
        (as = (e) => ({ type: wk, payload: { instanceId: e } })),
        (ss = (e, t, r, n) => ({
          type: Ak,
  ...
  var $m = c((Sj, Ym) => {
    ...
    function sG(e, t, r) {
      return (
        ...
        function () {
          for (
            var n = arguments, i = -1, o = Km(n.length - t, 0), a = Array(o);
            ++i < o;
  ...
  var hs = c((kj, my) => {
    ...
    function RG(e) {
      for (
        var t = e.name + "", r = Ey[t], n = CG.call(Ey, t) ? r.length : 0;
        n--;
  ...
  var Iy = c((Vj, Ty) => {
    ...
    function kG(e) {
      ...
      return (
        (t.__actions__ = DG(e.__actions__)),
  ...
  var Ay = c((Bj, wy) => {
    ...
    function _i(e) {
      if (BG(e) && !VG(e) && !(e instanceof GG)) {
        ...
        if (XG.call(e, "__wrapped__")) return HG(e);
      }
      return new Oy(e);
    }
    ...
    function oU(e) {
      return QG(function (t) {
        ...
        for (e && t.reverse(); n--; ) {
          ...
          if (i && !a && Es(o) == "wrapper") var a = new Cy([], !0);
        }
        for (n = a ? n : r; ++n < r; ) {
          o = t[n];
          var s = Es(o),
          ...
          u[9] == 1
            ...
            : (a = o.length == 1 && Ry(o) ? a[s]() : a.thru(o));
        }
        return function () {
          var l = arguments,
            m = l[0];
          if (a && l.length == 1 && JG(m)) return a.plant(m).value();
    ...
    s_ = he(() => {
      ...
      ($y = le(kt())),
        ({
          ...
          PAGE_SCROLL_DOWN: Qy,
          SCROLL_INTO_VIEW: Zy,
          SCROLL_OUT_OF_VIEW: AU,
          PAGE_SCROLL_UP: xU,
          SCROLLING_IN_VIEW: SU,
          PAGE_FINISH: Jy,
          ECOMMERCE_CART_CLOSE: CU,
          ECOMMERCE_CART_OPEN: RU,
          PAGE_START: e_,
          PAGE_SCROLL: NU,
        } = $e),
        (ys = "COMPONENT_ACTIVE"),
        ...
        (ct = (0, zy.default)([tn, LU])),
        (n_ = (e, t) => {
          if (t) {
            let { ixData: r } = e.getState(),
              { events: n } = r,
              i = n[t];
            if (i && !qU[i.eventTypeId]) return i;
          }
          return null;
        }),
        (PU = ({ store: e, event: t }) => {
          ...
          return (
            l &&
              hr({
                ...
                actionListId: (0, Ky.default)(l, "action.config.actionListId"),
              }),
            hr({
              store: e,
              eventId: a,
        ...
        (bs = { types: _s }),
        (qU = { PAGE_START: e_, PAGE_FINISH: Jy }),
        (en = (() => {
        ...
        (bi = (e = !0) => ({
          ...
          handler: Ze(
            e ? ct : tn,
            o_((t, r) => (r.isActive ? rn.handler(t, r) : r))
          ),
        })),
        (Ti = (e = !0) => ({
          ...i_,
          handler: Ze(
            e ? ct : tn,
            o_((t, r) => (r.isActive ? r : rn.handler(t, r)))
          ),
        })),
        (Xy = {
          ...bs,
        ...
        (a_ = {
          ...
          [bU]: bi(),
          [TU]: Ti(),
          [RU]: { types: "ecommerce-cart-open", handler: Ze(ct, Ve) },
          [CU]: { types: "ecommerce-cart-close", handler: Ze(ct, Ve) },
          [fU]: {
            types: "click",
            handler: Ze(
              ct,
            ...
            handler: (
              ...
              switch (a) {
                ...
                default: {
                  ...
                  if (N && ct({ element: t, nativeEvent: n }) !== !0) break;
                  let M = t.getBoundingClientRect(),
                    { left: P, top: z, width: K, height: $ } = M;
                  if (!N && !GU({ left: p, top: g }, M)) break;
                  (x = !0), (_ = b ? (p - P) / K : (g - z) / $);
                  break;
                }
              }
              return (
                w && (_ > 1 - jy || _ < jy) && (_ = Math.round(_)),
                (a !== ot.ELEMENT || x || x !== o.elementHovered) &&
                  ((_ = l ? 1 - _ : _), e.dispatch(gr(C, _))),
                {
                  elementHovered: x,
                  clientX: p,
                  clientY: g,
          ...
          [SU]: {
            ...
            handler: (
              ...
              if (m === ot.VIEWPORT) {
                let N = x ? o / s : a / u;
                return (
                  N !== i.scrollPercent && t.dispatch(gr(g, N)),
                  { scrollPercent: N }
                );
              } else {
                let N = Uy(n, g),
                ...
                return (
                  v !== i.scrollPercent && t.dispatch(gr(N, v)),
                  { scrollPercent: v }
                );
              }
            },
  ...
  function sV(e) {
    Gt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: lV }),
      Gt({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: fV }),
      Gt({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: dV }),
      Gt({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: pV });
  }
  function uV(e) {
    Gt({
      store: e,
  ...
  function fV(e, t) {
    ...
    if (n && i && m && s) {
      ...
      p && (m = $U({ actionList: p, actionItemId: i, rawData: m }));
    }
    if (
      (Si({ store: t, rawData: m, allowEvents: a, testManual: u }),
      ...
      l && p && t.dispatch(vr({ actionListId: n, isPlaying: !s }));
    }
  }
  function dV({ actionListId: e }, t) {
    e ? hr({ store: t, actionListId: e }) : b_({ store: t }), Ci(t);
  }
  function pV(e, t) {
    Ci(t), E_({ store: t, elementApi: qe });
  }
  function Si({ store: e, rawData: t, allowEvents: r, testManual: n }) {
    ...
    t && e.dispatch(es(t)),
      i.active ||
        ...
        r &&
          (yV(e), gV(), e.getState().ixSession.hasDefinedMediaQueries && uV(e)),
        e.dispatch(rs()),
        vV(e, n));
  }
  function gV() {
  ...
  function vV(e, t) {
    let r = (n) => {
      ...
      i.active &&
        (e.dispatch(di(n, o)), t ? cV(e, r) : requestAnimationFrame(r));
    };
    ...
    _.forEach((N) => {
      ...
      w.forEach(({ element: N, key: M }) => {
        let P = b[M],
          ...
          { actionTypeId: K } = z,
          $ = xi(K) ? As(K)(N, z) : null,
          Z = ws({ element: N, actionItem: z, elementApi: qe }, $);
        xs({
          store: e,
          element: N,
          eventId: n,
  ...
  function wV({ logic: e, store: t, events: r }) {
    ...
    (0, Er.default)(s, (p, g) => {
      ...
      rV(w, o.mediaQueryKeys) || t.dispatch(cs()),
        T.actionTypeId === ke.GENERAL_CONTINUOUS_ACTION &&
          (Array.isArray(h.config) ? h.config : [h.config]).forEach((x) => {
            let { continuousParameterGroupId: N } = x,
              M = (0, ht.default)(a, `${_}.continuousParameterGroups`, []),
              P = (0, l_.default)(M, ({ id: $ }) => $ === N),
              z = (x.smoothing || 0) / 100,
        ...
        (T.actionTypeId === ke.GENERAL_START_ACTION || Is(T.actionTypeId)) &&
          __({ store: t, actionListId: _, eventId: b });
    });
    let u = (p) => {
        ...
        IV(s, (h, T, b) => {
          ...
          if (!Ai(x, g.mediaQueryKey)) return;
          let N = (M = {}) => {
            let P = i(
              {
                store: t,
          ...
          C.actionTypeId === ke.GENERAL_CONTINUOUS_ACTION
      ...
      m = ({ target: p = document, types: g, throttle: h }) => {
        g.split(" ")
          ...
          .forEach((T) => {
            let b = h ? l : u;
            p.addEventListener(T, b), t.dispatch(fi(p, [T, b]));
          });
      };
  ...
  function __({ store: e, actionListId: t, eventId: r }) {
    ...
    if (u && u.useFirstGroupAsInitialState) {
      let l = (0, ht.default)(u, "actionItemGroups[0].actionItems", []),
        m = (0, ht.default)(s, "mediaQueries", n.mediaQueryKeys);
        ...
        let { config: g, actionTypeId: h } = p,
          T =
            g?.target?.useEventTarget === !0 && g?.target?.objectId == null
              ...
              : g,
          b = wi({ config: T, event: s, elementApi: qe }),
          w = xi(h);
        b.forEach((_) => {
          let C = w ? As(h)(_, p) : null;
          xs({
            destination: ws({ element: _, actionItem: p, elementApi: qe }, C),
            immediate: !0,
            store: e,
            element: _,
            eventId: r,
  ...
  function b_({ store: e }) {
    ...
    (0, Er.default)(t, (r) => {
      if (!r.continuous) {
        ...
        Ss(r, e), i && e.dispatch(vr({ actionListId: n, isPlaying: !1 }));
      }
    });
  }
  function hr({
  ...
  function nn({
    ...
    o >= T.length && (0, ht.default)(p, "config.loop") && (o = 0),
      o === 0 && b && o++;
    let _ =
        (o === 0 || (o === 1 && b)) && Is(p.action?.actionTypeId)
          ? p.config.delay
          : void 0,
      C = (0, ht.default)(T, [o, "actionItems"], []);
    if (!C.length || !Ai(g, l.mediaQueryKey)) return !1;
    ...
    return (
      C.forEach((P, z) => {
        ...
        wi({
          ...
          M = !0;
          let re = N === z && D === 0,
            F = KU({ element: L, actionItem: P }),
            X = ws({ element: L, actionItem: P, elementApi: qe }, U);
          xs({
            store: e,
            element: L,
            actionItem: P,
  ...
  function xs(e) {
    let { store: t, computedStyle: r, ...n } = e,
      ...
      p = !u,
      g = XU(),
      { ixElements: h, ixSession: T, ixData: b } = t.getState(),
      w = WU(h, i),
      { refState: _ } = h[w] || {},
      C = ps(i),
      x = T.reducedMotion && zo[o.actionTypeId],
      N;
    if (x && u)
    ...
    Gt({ store: t, select: ({ ixInstances: P }) => P[g], onChange: I_ }),
  ...
  function Ss(e, t) {
    ...
    let { elementId: r, actionItem: n } = e,
      ...
      { ref: o, refType: a } = i[r] || {};
    a === h_ && JU(o, n, qe), t.dispatch(as(e.id));
  }
  function T_(e, t, r) {
    ...
    if (Ai(z, N.mediaQueryKey) && (n || r || i)) {
      ...
      if (i) {
        if (b) {
          ...
          _ && !K && t.dispatch(vr({ actionListId: T, isPlaying: !1 }));
        }
        Ss(e, t);
      }
    }
  ...
  var l_,
    ...
    Ts = he(() => {
      ...
      (TV = (e, t) => (0, d_.default)((0, g_.default)(e, t), p_.default)),
        (IV = (e, t) => {
          (0, Er.default)(e, (r, n) => {
            r.forEach((i, o) => {
              let a = n + Os + o;
  ...
  var A_ = c((Et) => {
    ...
    var RV = Wo(),
      ...
      LV = SV((gi(), tt(Sm)));
    Et.actions = LV;
    var Rs = (Et.store = (0, RV.createStore)(NV.default));
    function PV(e) {
      e() && (0, Cs.observeRequests)(Rs);
    }
    function qV(e) {
      w_(), (0, Cs.startEngine)({ store: Rs, rawData: e, allowEvents: !0 });
    }
    function w_() {
      (0, Cs.stopEngine)(Rs);
    }
      ...
      (N_.exports = function (e, t) {
        ...
        function h() {
          (i = o && mr.env("design")),
            ...
            mr.scroll.off(b),
            (p = []);
          for (var _ = document.links, C = 0; C < _.length; ++C) T(_[C]);
          p.length && (mr.scroll.on(b), b());
        }
        function T(_) {
          if (!_.getAttribute("hreflang")) {
            ...
            if (((s.href = C), !(C.indexOf(":") >= 0))) {
              ...
              if (
                ...
                var N = e(s.hash);
                N.length && p.push({ link: x, sec: N, active: !1 });
                return;
              }
              if (!(C === "#" || C === "")) {
                var M =
                  s.href === a.href || C === g || (l.test(C) && m.test(g));
                w(x, u, M);
              }
            }
          }
        ...
        function x(A, v) {
          ...
          switch (v) {
            case "add":
              (L = A.attr("tabindex")),
                L
                  ? A.attr("data-wf-tabindex-swap", L)
                  : A.attr("tabindex", "-1");
              break;
            case "remove":
            ...
            if (a) {
              ...
              (m = C),
                Math.abs(x) > u &&
                  r &&
                  String(r()) === "" &&
                  (i("swipe", w, { direction: x > 0 ? "right" : "left" }), T());
            }
          }
          function h(w) {
  ...
  var G_ = c((az, k_) => {
    ...
    Ut.define(
      ...
      (k_.exports = function (e, t) {
        ...
        function P() {
          (a = i && Ut.env("design")), (M = N.find(u)), M.each(z);
        }
        function z(d, B) {
          var W = e(B),
            q = e.data(B, u);
          ...
          oe || (oe = "w-dropdown-toggle-" + d),
            ...
            q.toggle.prop("tagName") !== "BUTTON" &&
              (q.toggle.attr("role", "button"),
        ...
        function $(d) {
          return function (B, W) {
            (W = W || {}),
              K(d),
              W.open === !0 && G(d, !0),
              W.open === !1 && A(d, { immediate: !0 });
          };
        }
        function Z(d, B) {
          return r(function (W) {
            if (d.open || (W && W.type === "w-close"))
              return A(d, { forceClose: B });
            G(d);
          });
        }
        function G(d) {
        ...
        function D(d) {
          return (
            d.mouseUpOutside && N.off(_, d.mouseUpOutside),
            r(function (B) {
              if (d.open) {
                var W = e(B.target);
        ...
        function re(d) {
          return function () {
            (d.hovering = !1), d.links.is(":focus") || A(d);
          };
        }
        function F(d) {
          return r(function (B) {
          ...
          return function (B) {
            if (!(a || !d.open))
              switch (
                ...
                case Je.HOME:
                  return d.open
                    ? ((d.selectedIdx = 0), Q(d), B.preventDefault())
                    : void 0;
                case Je.END:
                  return d.open
                    ...
                    : void 0;
                case Je.ESCAPE:
                  return A(d), d.toggle.focus(), B.stopPropagation();
                case Je.ARROW_RIGHT:
                case Je.ARROW_DOWN:
                  return (
        ...
        function k(d) {
          return r(function (B) {
            ...
            return _e || A(d), B.stopPropagation();
          });
        }
        return n;
      })
      ...
      return function (h) {
        ...
        var T = h.form,
          b = {
            ...
            pageId: T.attr("gateshed-page-id") || "",
    ...
    Ni.define(
      ...
      (V_.exports = function (e, t) {
        ...
        function N() {
          ...
          n.on(
            ...
            n.on("change", s + ' form input[type="radio"]', (W) => {
              e(`input[name="${W.target.name}"]:not(${F})`).map((oe, _e) =>
                e(_e).siblings(X).removeClass(Q)
              );
              let q = e(W.target);
        ...
        function P(F) {
          var X = F.btn,
            Q = F.wait;
          X.prop("disabled", !0), Q && ((F.label = X.val()), X.val(Q));
        }
        function z(F, X) {
          var Q = null;
          return (
        ...
        function K(F) {
          var X = {};
          return (
            F.find(':input[type="file"]').each(function (Q, V) {
              var k = e(V),
                d = k.attr("data-name") || k.attr("name") || "File " + (Q + 1),
                B = k.attr("data-value");
              typeof B == "string" && (B = e.trim(B)), (X[d] = B);
            }),
            X
          );
        }
          ...
          return (
            X === "password"
              ...
              ? V
                ? l.test(F.attr("type")) &&
                  (m.test(V) ||
                    (k = "Please enter a valid email address for: " + Q))
                : (k = "Please fill out the required field: " + Q)
        ...
        function U(F, X) {
          ...
          function y(I, R) {
            ...
            var ee = R.fileName,
              ...
              pe = R.fileId,
              j = R.s3Url;
            q.attr("data-value", pe), re(j, ie, Q, ee, O);
          }
          function O(I) {
            if (I) return f(I);
            d.toggle(!1),
        ...
        function te(F, X) {
          var Q = new URLSearchParams({ name: F.name, size: F.size });
  ...
  var W_ = c((cz, H_) => {
    ...
    At.define(
      ...
      (H_.exports = function (e, t) {
        ...
        function D(E) {
          return function (H) {
            switch (H.keyCode) {
              case Se.SPACE:
              case Se.ENTER:
                return F(E)(), H.preventDefault(), H.stopPropagation();
              case Se.ESCAPE:
                return se(E), H.preventDefault(), H.stopPropagation();
              case Se.ARROW_RIGHT:
              case Se.ARROW_DOWN:
              case Se.HOME:
              case Se.END:
        ...
        function Q(E) {
          return (
            E.outside && o.off("click" + h, E.outside),
            function (H) {
              var J = e(H.target);
        ...
        function k(E, H) {
          ...
          if ((J.open && !Y && !l && se(J, !0), J.container.length)) {
            var ge = B(J);
        ...
        function oe(E, H) {
          ...
          if (
            (E.overlay &&
              ((N = E.menu.prev()), E.overlay.show().append(E.menu)),
            J.animOver)
          ) {
            n(E.menu)
              .add(O)
              .set({ x: J.animDirect * lt, height: ge })
              .start({ x: 0 })
              .then(I),
          ...
          var S = f + St;
          n(E.menu).add(O).set({ y: -S }).start({ y: 0 }).then(I);
          function I() {
        ...
        function se(E, H) {
          ...
          if (J.animOver) {
            n(E.menu)
              .add(Y)
              .start({ x: St * J.animDirect })
              .then(y);
            return;
          }
          var f = lt + ge;
          n(E.menu).add(Y).start({ y: -f }).then(y);
          function y() {
            E.menu.height(""),
              ...
              E.overlay &&
                ...
                (N.length ? E.menu.insertAfter(N) : E.menu.prependTo(E.parent),
    ...
    xt.define(
      ...
      (X_.exports = function (e) {
        ...
        (t.ready = t.design = t.preview = w),
          ...
          (t.destroy = function () {
            (i = n.find(p)), i.length && (i.each(x), _());
          });
        function w() {
          (o = u && xt.env("design")),
            (i = n.find(p)),
            i.length &&
              (i.each(N), xt.env("preview") && !b && i.each(x), _(), C());
        }
        function _() {
        ...
        function $(G, A) {
          ...
          if (D !== G.current) {
            ...
            X.length && v.outro
              ? (X.each(T.outro),
                r(X)
                  .add("opacity " + v.outro + "ms " + L, { fallback: s })
                  .start({ opacity: 0 })
                  .then(() => Z(v, X, F)))
              : Z(v, X, F);
          }
...
Webflow.require("ix2").init({
  events: {
    "e-575": {
      ...
      target: {
        id: "65ea1a4006e947d7284b216d|45f035ae-3fb2-bb4d-27e2-74aea56ac52b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-593": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|7817e8f3-82b1-0e9c-cfa7-31c942b28bfe",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-595": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|e08551a4-6e42-ec15-3202-06d56dbe0f9b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-597": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|5e032563-fc70-7e4e-29f5-375f64be0ac1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-599": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|7c13726e-39d9-de9a-2f36-7f54db9db2d2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-601": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|08eaad80-63e2-0007-004f-1111b64ecf9a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-603": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|869cadb5-148b-228b-dcd9-98bc234a303f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-605": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|589fae43-b9c2-b560-5f36-3a1c5debaa4b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-607": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|088411a7-8b96-6148-5f5c-e2c8f1c8352e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-609": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|0221810c-481a-c6cc-fb11-267d5b034c2a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-611": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|8be9102c-734e-daaa-58ea-073e75b358a0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-613": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|056642f3-a6d1-f76c-d1f4-c07fa49c0c62",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-615": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|f465cedf-824f-81da-3b53-1d95eea8b8b6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-617": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|563cc292-91ef-d31d-ef4b-5f538e5497a3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-619": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|374ff64b-9366-70ff-639a-fbfd3e009127",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-621": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|8388ada1-87de-b2f8-a35a-f46fce871dd7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-623": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|7f902ab2-e22b-804b-b38b-2cb339e6c4bd",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-625": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|00bac3da-ea71-ca65-c784-7286564f79ce",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-627": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cf|07f186f2-0429-e142-747e-c1fb0c5be6a6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-631": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|0f720cf4-d1d6-6555-6d5a-8c83ed524e29",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-647": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|e701b93b-04d8-0ade-4f08-48a7edebb183",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-649": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|ac23ba95-b5bb-55b3-b9ca-366ac778105a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-651": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|3b76df7e-d37c-1f8d-6a2d-45c96a6b21ca",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-661": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|3a128cf1-a4b6-0ac9-3850-08e8637ffea0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-679": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|6043b438-28bc-51a9-5d72-f3916795ac8d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-681": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|6043b438-28bc-51a9-5d72-f3916795ac99",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-683": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|6043b438-28bc-51a9-5d72-f3916795ac9b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-685": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|6043b438-28bc-51a9-5d72-f3916795ac9d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-687": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|6043b438-28bc-51a9-5d72-f3916795ac9f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-693": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|f8c0ddfc-9a40-7a22-f370-30b2b9dacf76",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-699": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|4465db7b-a0e8-0e3a-ae51-079757a8a9ca",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-701": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|4465db7b-a0e8-0e3a-ae51-079757a8a9ed",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-703": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|71679ee7-cf68-d21f-cde2-a3de7139553d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-705": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|71679ee7-cf68-d21f-cde2-a3de7139553a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-707": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|5241045e-9b88-7dd7-b0b6-3aa6d094355f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-709": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|5241045e-9b88-7dd7-b0b6-3aa6d0943566",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-763": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "89eb64a6-864c-c3c9-3e69-cd7464a257b6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-779": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2137|38111990-697f-e1c5-5ace-acb3363b51a9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-799": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cc|31ba3a51-431d-d89c-e71c-dea04bf98649",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-801": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cc|e605bb52-92c9-e3bb-6159-7fedb68f3c9f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-803": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2167|f902ddcc-19b1-f2ab-ee3e-ece68c425b4c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-833": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2162|a1c9d092-9c2c-5faa-ff2f-ca4a0ff67df4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-835": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2162|a1c9d092-9c2c-5faa-ff2f-ca4a0ff67df6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-855": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2162|13639f88-e452-7569-9a3b-ba9177834b3f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-857": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2162|50f25ff3-c3e6-bcf3-59f2-c3844ef3a53a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-859": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2162|4fa5ed4e-1361-d140-6abb-7292e123e4db",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-861": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2162|5831558f-340b-1998-4ac5-74602faad80b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-871": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|55ded26b-1750-4b75-7b5a-a947b0642490",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-897": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|39fde7b6-066c-f244-07e8-1304b3a8be5e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-899": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|ceddd6d9-77fd-c2b9-11bc-553dcae2b2af",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-903": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|0c151710-ebc0-6952-bab7-76ca8b3a293a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-905": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|fe2bb575-b911-6d96-1a73-74d9e7b43bc5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-907": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|c532e865-6bbb-7cb0-a7ee-b9ede899777e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-909": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|0f720cf4-d1d6-6555-6d5a-8c83ed524e25",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-926": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20f4|4fb02223-3b81-5b3a-fb0b-82eea3486d5f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-930": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2137|c516d9f5-80d7-eb65-ae4d-e5a319d0b2f1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-942": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2162|a1c9d092-9c2c-5faa-ff2f-ca4a0ff67de3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-944": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20f4|53ed6546-c5e9-7dcb-7d09-7813f51efd04",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-950": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cc|c63c3555-896b-25a9-017a-3563b0c190a7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-952": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20cb|408f02e7-f786-bf85-a42c-474816609185",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-963": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2162|216f7c56-5650-0cf2-2fbe-b0b61f567e9b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-968": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|be3aa093-72ae-cf72-8079-5da3d4c79fce",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-980": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|049b7066-81d3-709f-3f96-09f8c2ae8c5a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-986": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|563f507f-8d0a-64a1-5dde-d7579382c29a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-988": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|360f7257-af9b-6341-4281-29c1f576567a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-990": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "49c7ee43-0947-46dc-0e72-1353503c3031",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-992": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "660320e127d257093447ec94|ff02636d-6996-b9cf-df11-776fa7df0dd3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1004": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|d50b6f1f-30b8-ef04-44d9-6f56a9024454",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1006": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|6a62342e-4759-36f1-141d-3a010cd27b71",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1008": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|d82b62b6-74f2-d7aa-7369-9562b706b958",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1010": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|c5f1daa3-2d41-9af4-078c-50af9322dbb9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1012": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|24cd15b8-94af-9d71-f226-73367647ef94",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1013": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|8bba5234-8863-ef89-ad58-af8a11d917e1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1014": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|df27f3c6-f95c-f990-d692-2e6516205846",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1015": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|8907dc84-8f59-7303-a649-78a34f58ebe1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1016": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|e22e1fd7-5250-d448-4c71-f6300ff2e860",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1017": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|24312d1c-48bd-2dcc-1be6-b2dd337c207a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1018": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|c806d129-0455-35f7-6fa7-2d44415d7259",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1019": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|fca51f6e-ad9f-1044-bec3-73b981b3efb2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1020": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|d87235c6-7efa-06ba-2eaf-f765c174c96e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1021": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|6350fc3e-82e5-fdf0-926c-f14cd61ea2ba",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1022": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|3c59e304-7a13-7a25-ce89-94ea405693fb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1023": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|4e4b232b-becb-e8ca-b2bc-f68544e2c34c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1024": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|5c8245bf-0d57-f130-3d8c-a3dd371deb89",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1025": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|5cabcc35-052b-14c7-8292-9ec12e05d408",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1026": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "660320e127d257093447ec94|9721192c-d700-2e17-621f-c22cbbc1e510",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1028": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "660320e127d257093447ec94|8384a220-175e-737e-9557-e9e2280ae75d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1032": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "660320e127d257093447ec94|19abb4fe-9a30-aef3-ae76-70ee83e830cb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1034": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "660320e127d257093447ec94|61e59258-f398-a2bf-76db-2802feb2b678",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1036": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "660320e127d257093447ec94|1ccb5f91-374b-d476-feca-c16e6160c47a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1038": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65fc9160a4f396599f5f44ab|a2b3b510-2674-6838-60cc-6fc10babc638",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1040": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65fc9160a4f396599f5f44ab|8f560f31-a644-76f6-c9fa-1b5f7ceb6682",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1042": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65fc9160a4f396599f5f44ab|91dd1692-64d6-6be3-1585-f591aca005e7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1044": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65fc9160a4f396599f5f44ab|c3400689-eec1-b64c-66c8-f09c7b14bfce",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1046": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65fc9160a4f396599f5f44ab|3fd7b8a1-38d8-3e0b-9638-b7413314aff1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1048": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65fc9160a4f396599f5f44ab|22239cf5-c2e6-bdd9-6d8e-67cb11f6c334",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1050": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b2162|e4d1b5d8-c666-33f7-604f-5fc29f811d21",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1053": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|1673a658-fc97-cd35-128e-ef9706cd70c1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1055": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "83395116-5681-5712-4824-268c49216e96",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1057": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "83395116-5681-5712-4824-268c49216e9a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1059": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "h37g73i64t25ui|ceddd6d9-77fd-c2b9-11bc-553dcae2b2b0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1061": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20f4|cab2640a-6e5e-1958-83c4-55178b26693d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1069": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65ea1a4006e947d7284b20f4|53ed6546-c5e9-7dcb-7d09-7813f51efd0d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-1071": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "660320e127d257093447ec94|ff02636d-6996-b9cf-df11-776fa7df0dcd",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "65ea1a4006e947d7284b20cf|2e279085-eac3-8e7e-bd1d-ccc4fbfcf41c",
                },
                xValue: -100,
                xUnit: "px",
                yUnit: "PX",
    ...
    "a-37": {
      id: "a-37",
      title: "Element Slide In Right Delay 0.5",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-36": {
      id: "a-36",
      title: "Element Slide In Right Delay 0.25",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-39": {
      id: "a-39",
      title: "Element Slide In Left Delay 0.25",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-40": {
      id: "a-40",
      title: "Element Slide In Left Delay 0.5",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-43": {
      id: "a-43",
      title: "Element Slide In Top Delay 0.30",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-46": {
      id: "a-46",
      title: "Element Slide In Bottom Delay 0.5",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-45": {
      id: "a-45",
      title: "Element Slide In Bottom Delay 0.25",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-52": {
      id: "a-52",
      title: "Element Opacity Drop Duration 2.0",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-51": {
      id: "a-51",
      title: "Element Opacity Drop Duration 1.0",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-50": {
      id: "a-50",
      title: "Element Opacity Drop Duration 0.5",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".body-text-s",
                  selectorGuids: ["69733c75-e136-c8aa-374a-0f89d78d70dc"],
                },
                value: "none",
              },
            },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "49c7ee43-0947-46dc-0e72-1353503c3046",
                },
                zValue: 0,
                xUnit: "DEG",
                yUnit: "DEG",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "49c7ee43-0947-46dc-0e72-1353503c3048",
                },
                zValue: 0,
                xUnit: "DEG",
                yUnit: "DEG",
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "49c7ee43-0947-46dc-0e72-1353503c3047",
                },
                value: 0,
                unit: "",
              },
    ...
    "a-60": {
      id: "a-60",
      title: "Element Scale + Saturation",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "h37g73i64t25ui|2d9f06b4-4d1a-e62a-bb6a-a0f869f4973b",
                },
                filters: [
                  {
                    type: "brightness",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                filters: [
                  { type: "saturate", filterId: "7e86", value: 130, unit: "%" },
                ],
              },
            },
          ],
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                filters: [
                  { type: "saturate", filterId: "2e02", value: 100, unit: "%" },
                ],
              },
            },
          ],
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1691142166319,
    },
    "a-53": {
      id: "a-53",
      title: "Element Scale + Brightness",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-63": {
      ...
      createdOn: 1691488588316,
    },
    "a-64": {
      id: "a-64",
      title: "Element Hover In",
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1691755121086,
    },
    "a-65": {
      id: "a-65",
      title: "Element Hover Out",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: ".pop-up",
                  selectorGuids: ["84a94971-0c1a-653b-0aa0-035350f0e6b0"],
                },
                value: 0,
                unit: "",
              },
    ...
    "a-66": {
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1691755383252,
    },
    "a-68": {
      id: "a-68",
      title: "Navbar BG Change Open",
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1711980364161,
    },
    "a-69": {
      id: "a-69",
      title: "Navbar BG Change Close",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-71": {
      ...
      createdOn: 1712159885400,
    },
    "a-75": {
      id: "a-75",
      title: "Element Move Down 200px",
      continuousParameterGroups: [
        {
          id: "a-75-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: true,
                      id: "6612f55952e283944f3ab2c5|55ded26b-1750-4b75-7b5a-a947b0642490",
                    },
                    yValue: -5,
                    xUnit: "DEG",
                    yUnit: "deg",
